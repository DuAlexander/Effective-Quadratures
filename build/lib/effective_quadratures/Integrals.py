...
def sparseGrid(uq_parameters, indexSetObject):
    ...
    for i in range(0, rows):
        ...
        points, weights = PolyParent.getGaussianQuadrature(uq_parameters, orders[i,:])
...
def tensorGrid(uqParameters, indexSetObject):
    ...
    points, weights = PolyParent.getGaussianQuadrature(uqParameters, max_orders)
